...
const CHAMPIONS = [
    ...
    { name: '자헨', engName: 'Zaahen', role: '전사', lane: '정글/탑', img: 'https://ddragon.leagueoflegends.com/cdn/15.24.1/img/champion/Zaahen.png', difficulty: '상' },
    { name: '멜', engName: 'Mel', role: '마법사', lane: '미드', img: 'https://ddragon.leagueoflegends.com/cdn/15.24.1/img/champion/Mel.png', difficulty: '상' },
    { name: '유나라', engName: 'Yunara', role: '원거리', lane: '원딜', img: 'https://ddragon.leagueoflegends.com/cdn/15.24.1/img/champion/Yunara.png', difficulty: '상' },
